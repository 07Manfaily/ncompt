...
const ProfileDashboard = () => {
    ...
    // États pour les nouveaux onglets
    ...
    const handleEditSession = (session) => {
        ...
        setActiveTab("general"); // Reset to first tab when opening
        setSessionData({
        ...
        session.participants?.forEach(participant => {
            initialPresence[participant.matricule] = false; // Par défaut absent
        });
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            ...
                            <div style={{ display: "flex", gap: "16px" }}>
                                ...
                                <span style={{ fontSize: "12px", color: "#6b7280" }}>
                                    Non marqués: {selectedSession.participants.length - Object.keys(presenceData).length}
                                </span>
                            </div>
                        </div>
                    </div>
